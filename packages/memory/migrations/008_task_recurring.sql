...
GRANT EXECUTE ON FUNCTION next_anchor(TEXT,DATE) TO braintrust_api;
GRANT EXECUTE ON FUNCTION spawn_recurrences() TO braintrust_api;
GRANT EXECUTE ON FUNCTION due_reminders(BOOLEAN) TO braintrust_api;
GRANT EXECUTE ON FUNCTION task_maintenance() TO braintrust_api;
