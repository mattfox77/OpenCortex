...
GRANT EXECUTE ON FUNCTION task_assign(UUID,TEXT) TO opencortex_memory_api;
GRANT EXECUTE ON FUNCTION task_list(TEXT,TEXT,TEXT,TEXT,BOOLEAN,INTEGER,TEXT,TEXT) TO opencortex_memory_api;
GRANT EXECUTE ON FUNCTION task_next(TEXT,INTEGER,TEXT) TO opencortex_memory_api;
